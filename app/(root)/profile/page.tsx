                  ...
                  <TableBody>
                    ...
                    {user?.dateOfBirth && (
                      <TableRow sx={{ textAlign: "center" }}>
                        ...
                        <TableCell>{user?.dateOfBirth.split("T")[0]}</TableCell>
                      </TableRow>
                    )}
                    {user?.anniversaryDate && (
                      <TableRow sx={{ textAlign: "center" }}>
                        ...
                        <TableCell>
                          {user?.anniversaryDate.split("T")[0]}
                        </TableCell>
                      </TableRow>
                    )}
                    {user?.fatherHusbandName && (
                      <TableRow sx={{ textAlign: "center" }}>
                        <TableCell>Father/HusbandName</TableCell>
                        <TableCell>{user?.fatherHusbandName}</TableCell>
                      </TableRow>
                    )}
                    {user?.mobile && (
                      <TableRow sx={{ textAlign: "center" }}>
                    ...
                    {user?.residentialAddress && (
                      <TableRow sx={{ textAlign: "center" }}>
                        ...
                        <TableCell>{user?.residentialAddress}</TableCell>
                      </TableRow>
                    )}
                      ...
                      <TableRow sx={{ textAlign: "center" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            <MenuItem value="get_stronger">
                              Get Stronger
                            </MenuItem>
                            <MenuItem value="get_healthier">
                              Get Healthier
                            </MenuItem>
                            <MenuItem value="get_more_flexible">
                              Get More Flexible
                            </MenuItem>
                            <MenuItem value="get_more_muscular">
                              Get More Muscular
                            </MenuItem>
                            <MenuItem value="learn_the_basics">
                              Learn The Basics
                            </MenuItem>
                          </Select>
                        </TableCell>
                      ...
                      <TableCell>
                        <TextField
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              getValues("confirmPassword") === e.target.value
                            ) {
